...
if __name__ == '__main__':
    ...
    #Loop until GPS gets first fix (tacks satalites) 
    #and is in NAVIGATION MODE. This also logs the GPS NMEA Sentences
    #into a aray and prints out to screen
    while GPS_PARSE.fix_data == "no_fix":
        GPS_PARSE.parse_gps_sentence()


    print("GPS FIX: GPS Satellites and Navigation Acquired...")
    ...
    #Parse Raw GPS NMEA data and generate logs by writing to individual csv file 
